...
import { AiFillEye, AiFillMessage as MessengerIcon } from "react-icons/ai";
  ...
  return (
    <Link to={`/${post._id}`}>
      <div className="flex flex-col basis-1/4 flex-grow">
        ...
        >
          {post.imgUrl && (
            <img
              ...
              alt="img"
              className="post-image object-cover w-full"
            />
          )}
        </div>
        ...
        <p className="text-white text-xs opacity-60 pt-4 line-clamp-3">
          {post.text}
        </p>
